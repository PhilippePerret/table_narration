...
function update_auto_test {
	...
	rsync -ruvt -f'- \.git*' -f'- */\.*' -f'- \.*' -f'- _Dev/?' --exclude="tests/*" --delete ~/Sites/cgi-bin/lib/javascript/optional/PureJavascriptTests/-\>Site/tests/xlib/ ~/Sites/cgi-bin/lib/javascript/optional/PureJavascriptTests/-\>Site/tests/xlib/tests/tests/xlib
}
